...
public class ChatRoomResponseDto {
    ...
    public static class DetailDto{
        ...
        private List<ChatMessageResponseDto.MessageDto> sellerMessageList;  // 메시지, 시간
        ...
        private List<ChatMessageResponseDto.MessageDto> customerMessageList;  // 메시지, 시간
    ...
    public static class ScreenDto{
        ...
        private ChatMessageResponseDto.MessageDto messageInfo;  // 마지막으로 보낸 메시지, 시간
    }
}